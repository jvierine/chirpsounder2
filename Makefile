...
benchmark_downconvert: benchmark_downconvert.c chirp_downconvert.h
	gcc -O3 -march=native -ffast-math -fno-strict-aliasing -o benchmark_downconvert benchmark_downconvert.c -lm
